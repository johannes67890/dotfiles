...

{
  programs.plasma = {
    ...
    configFile = {
      ...
      kscreenlockerrc."Greeter/Wallpaper/org.kde.image/General".Image = "/home/jgjo/Pictures/686965.png";
      kscreenlockerrc."Greeter/Wallpaper/org.kde.image/General".PreviewImage = "/home/jgjo/Pictures/686965.png";
      ...
      plasmarc.Wallpapers.usersWallpapers = "/home/jgjo/Pictures/686965.png";
    };
    dataFile = {
...
[jgjo@jgjo:~]$ nix run github:nix-community/plasma-manager
{
  programs.plasma = {
    enable = true;
    shortcuts = {
